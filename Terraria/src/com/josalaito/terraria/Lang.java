...
public class Lang {
	...
	public static String dialog(int l, boolean english)
	{
		english = false;
	...
	public static String setBonus(int l, boolean english)
	{
		english = false;
		if (Lang.lang <= 1 || english)
		{
	...
	public static String npcName(int l, boolean english)
	{ 
		english = false;
		if (Lang.lang <= 1 || english)
		{
	...
	public static String toolTip(int l, boolean english)
	{
		english = false;
		if (l == 1372)
		{
	...
	public static String toolTip2(int l, boolean english)
	{
		english = false;
		if (Lang.lang <= 1 || english)
		{
	...
	public static String itemName(int l, boolean english)
	{
		english = false;
		if (Lang.lang <= 1 || english)
		{
	...
	public static void setLang(boolean english)
	{
		english = false;
		Main.chTitle = true;
		if (Lang.lang <= 1 || english)
	...
	public static String deathMsg(int plr, int npc, int proj, int other)
	{
		plr = -1;
		npc = -1;
		proj = -1;
